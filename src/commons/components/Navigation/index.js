...
const NavigationBackground = styled.div`
  ...
  transition: ${props => props.active ? 'all 0.4s ease-in' : 'all 0.4s ease-out'};
  background-image: radial-gradient(${props => props.theme.accent.light}, ${props => props.theme.accent.dark})}
`;
